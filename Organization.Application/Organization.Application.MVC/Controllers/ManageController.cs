...
namespace Organization.Application.MVC.Controllers
{
    ...
    public partial class ManageController : BaseController
    {
        ...
        public ManageController(CustomUserManager userManager, CustomSignInManager signInManager)
        {
            ...
            _CustomSignInManager = signInManager;
        }
        ...
        public virtual async Task<ActionResult> Roles()
        {
            var builder = new RoleModelBuilder();
        ...
        {
            var user = CustomUser.FindById(User.Identity.GetUserId());
            if (user != null)
            {
